...
# GSD formula: (Altitude * pixel_size) / FocalLength
df["GSD"] = (df["AbsoluteAltitude"] * pixel_size_m) / df["FocalLength"]
...
for _, row in df.iterrows():
    ...
    # Create rectangle footprint in meters
...
print("Attributes: SourceFile, AbsoluteAltitude, FocalLength, FlightYawDegree, GSD, FootprintWidth_m, FootprintHeight_m")</pre>
